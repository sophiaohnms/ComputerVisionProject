...
class Resnet50Model(torch.nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # for param in self.layer1.parameters():  # Freeze all parameters in 1st layer
        #    param.requires_grad = False
        # print("Layer 1: ", self.layer1)

        self.layer2 = nn.Sequential(
            *list(original_model.children())[-4:-3]
        )
        # print("Layer 2: ", self.layer2)

        self.layer3 = nn.Sequential(
            *list(original_model.children())[-3:-2]
        )
        # print("Layer 3 ", self.layer3)

        self.layer4 = nn.Sequential(
            *list(original_model.children())[-2:-1]
        )
        # self.layer4 = nn.Sequential(
